...
public class DatabaseConnection {
    ...
    public void insertPosition(String in_name, double in_salary) throws SQLException
    {
    ...
    public void insertScreeningRoom(int in_amount_of_rows, int in_amount_of_columns) throws SQLException
    {
